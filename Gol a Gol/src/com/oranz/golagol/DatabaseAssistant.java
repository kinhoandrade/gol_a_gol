...
public class DatabaseAssistant
{
	...
	private static final String EXPORT_FILE_NAME = Environment.getExternalStorageDirectory().getPath() + "/gol_a_gol_export.xml" ;
...
//		}
	...
	class Exporter
	{
		...
		{
			this( new BufferedOutputStream( _ctx.openFileOutput( EXPORT_FILE_NAME, Context.MODE_WORLD_READABLE ) ) );
		}
